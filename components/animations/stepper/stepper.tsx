...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
    ...
    return (
        <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
            <motion.div
                variants={{
                    inactive: { scale: 1, backgroundColor: '#1A0B2E', color: '#A090B0', border: '1px solid rgba(255,255,255,0.1)' },
                    active: { scale: 1, backgroundColor: '#7CFF8A', color: '#12001F', border: '1px solid #7CFF8A' },
                    complete: { scale: 1, backgroundColor: '#7CFF8A', color: '#12001F', border: '1px solid #7CFF8A' }
                }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
    const lineVariants: Variants = {
        ...
        complete: { width: '100%', backgroundColor: '#7CFF8A' }
    };
